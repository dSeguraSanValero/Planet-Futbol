...
<html lang="en" data-bs-theme="auto">
    <head>
      ...
      <link rel="icon" type="image/ico" href="https://img.freepik.com/vector-premium/futbol-diseno-logotipo-tienda-mercado-ilustracion-bolsa-compras_567637-384.jpg?w=2000">
  ...
  <div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      ...
      <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a href="about_us.jsp" class="nav-link">About us</a></li>
      </ul>
    </header>
    </div>
</main>
